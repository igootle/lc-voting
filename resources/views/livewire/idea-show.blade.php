   ...
   <div class="buttons-container flex items-center justify-between mt-6">
               ...
               <form action="#" class="space-y-4 px-4 py-6">
                  <div>
                     <textarea name="post_comment" id="post_comment" cols="30" rows="4"
                        class="w-full text-sm bg-gray-100 rounded-xl placeholder-pray-900 border-none px-4 py-2 "
               ...
               <form action="#" class="space-y-4 px-4 py-6">
                  ...
                  <div class="">
                     <textarea name="update_comment" id="" cols="30" rows="3"
                        ...
                        placeholder="Add an update coment (optional)"></textarea>
                  </div>
                  <div class="flex items-center justify-between space-x-3">
                     ...
                     <button type="submit"
                        class="flex items-center justify-center w-1/2 h-11 text-xs bg-blue text-white font-semibold rounded-xl border border-blue-200 hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">
      ...
      <div class="hidden md:flex items-center space-x-3">
         <div class="bg-white font-semibold text-center rounded-xl px-3 py-1">
            <div class="text-xl lending-snug">{{ $votesCount }}</div>
